...
public class JwtService
{
    ...
    {
        var expiration = DateTime.UtcNow.AddMinutes(user.UserName=="admin"?10000000:EXPIRATION_MINUTES);
    ...
    private JwtSecurityToken CreateJwtToken(Claim[] claims, SigningCredentials credentials, DateTime expiration) =>issuer==null?
